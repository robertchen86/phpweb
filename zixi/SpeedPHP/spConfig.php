...
return array(
	...
	'default_controller' => 'you_c_login', // 默认的控制器名称
	'default_action' => 'index',  // 默认的动作名称
	'url_controller' => 'c',  // 请求时使用的控制器变量标识
	'url_action' => 'a',  // 请求时使用的动作变量标识

	'auto_session' => TRUE, // 是否自动开启SESSION支持
	'dispatcher_error' => "spError('Routing error, please check the directory exists the controller of the controller / action.');", // 定义处理路由错误的函数
	...
	'db' => array(  // 数据库连接配置
		...
		'port' => 3306,        // 端口
		'login' => 'root',     // 用户名
		'password' => '12344321',      // 密码
		'database' => 'sq_zixishi',      // 库名称
		'prefix' => 'zx_',           // 表前缀
