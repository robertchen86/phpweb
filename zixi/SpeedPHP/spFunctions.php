...
function import($sfilename, $auto_search = TRUE, $auto_error = FALSE){
	...
	if( TRUE == $auto_error )spError('Can\'t find file:{$sfilename}');
	return FALSE;
}
...
function spClass($class_name, $args = null, $sdir = null){
	...
	if(preg_match('/[^a-z0-9\-_.]/i', $class_name))spError($class_name." Class name of the error, check。");
	...
	spError($class_name." Class definition does not exist, please check.");
}
