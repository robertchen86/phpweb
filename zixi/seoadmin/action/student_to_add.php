...
<script language="javascript" src="js/student_add.js"></script>
...
<ul id="innouni_sub_title">
	<li class="sub">添加学生</li>
</ul>
<div id="innouni_right_b">
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1">
  <form name="addform" id="addform" method="post" action="./?a=student_add" >
   <tr class="tdbg">
    ...
    <tr class="tdbg">
      ...
      <td ><input name="student_code" id="student_code" type="text" class="input" size="50" maxlength="30"> &nbsp;&nbsp;<span id='student_code_span'></span></td>
    </tr>
    <tr class="tdbg">
      <td width="12%" align="center" >姓名：</td>
      <td ><input name="student_name" id="student_name" type="text" class="input" size="50" maxlength="30"  onkeyup="value=value.replace(/[^\u4E00-\u9FA5]/g,&quot;&quot;) "> &nbsp;&nbsp;<span id='student_name_span'></span></td>
    </tr>
    <!-- 
    <tr class="tdbg">
