...
// 用户授权后重定向
$callback_url = 'http://www.innouni.com/wbzxs/seoadmin/seoadmin/?a=getYkToken&act=back';
$request_url .='?client_id='.$app_key.'&response_type=code&redirect_uri='.$callback_url;
echo $request_url;
$request_url ='https://openapi.youku.com/v2/oauth2/authorize?client_id=10000&response_type=code&redirect_uri=http%3A%2F%2Fclient.example.com%2Fcb&state=xyz';
$ch = curl_init();
