...
<div id="innouni_right_b">
  ...
  <form name="addform" id="addform" method="post" action="./?a=admin_edit" >
    <tr>
      <td width="12%" align="center" class="tdbg">帐 户：      <input name="admin_id" id="admin_id" type="hidden" value="<?=$_SESSION['inni_zixishi_userid'] ?>"></td>
      <td class="tdbg"><input name="username" id="username" type="text" class="input" size="30" value="<?=$_SESSION['inni_zixishi_user'] ?>" > &nbsp;&nbsp;<span id='username_span'></span></td>
    </tr>
