...
<script language="javascript" src="js/admin_com.js"></script>
...
<ul id="innouni_sub_title">
	<li class="sub">添加帐户</li>
</ul>
<div id="innouni_right_b">
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1">
  <form name="addform" id="addform" method="post" action="./?a=admin_add" >
    <tr>
      <td width="12%" align="center" class="tdbg">帐 户：      </td>
      <td class="tdbg"><input name="username" id="username" type="text" class="input" size="30"> &nbsp;&nbsp;<span id='username_span'></span></td>
    </tr>
    <tr class="tdbg">
